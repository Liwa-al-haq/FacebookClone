...
const Contacts = ({name,src,status}) => {
  return (
    <div className='flex items-center space-x-2 py-2 pl-1 cursor-pointer relative hover:bg-gray-200 rounded-l-xl'>
        <Image src={src} width={40} height={40} className='rounded-full cursor-pointer '/>
